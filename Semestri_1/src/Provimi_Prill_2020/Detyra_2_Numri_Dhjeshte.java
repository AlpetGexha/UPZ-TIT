...
/**
 * (20 pikë) Një numër i thjeshtë është një numër i plotë më i madh se 1 dhe që
 ...
 */
public class Detyra_2_Numri_Dhjeshte {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 0; i < v.length; i++) {
            if (isNatyral(v[i]))
                System.out.println(v[i] + "Natyral");
            else
                System.out.println(v[i] + "Jo Natyral");
        }
    }
