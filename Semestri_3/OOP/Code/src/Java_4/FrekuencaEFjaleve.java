...
public class FrekuencaEFjaleve {
    public static void main(String[] args) {
        ...
        try {
            BufferedReader reader = new BufferedReader(new FileReader("src/Java_4/text.txt"));
            PrintWriter writer = new PrintWriter(new FileWriter("src/Java_4/frekuencat.txt"));
