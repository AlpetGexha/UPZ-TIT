...
String token = "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEyMzMyMSJ9.dASvDkCc-JeOJjUObZWgN_IyXlLDUZJRMnLK3FhyaOk";
...
void loop() {
  ...
  if (client.connect(server, 80)) {
    ...
    client.println("POST /index.php?temperature="+String(temp)+"&humidity="+String(hum)+"&deviceid=1&token="+String(token)+" HTTP/1.1");
    client.print("Host: ");
